...
public static class FastPoissonDiskSampling
{
    ...
    public static List<Vector2Int> Sampling(Vector2 bottomLeft, Vector2 topRight, float minimumDistance)
    {
        return Sampling(bottomLeft, topRight, minimumDistance, DefaultIterationPerPoint);
    }

    public static List<Vector2Int> Sampling(Vector2 bottomLeft, Vector2 topRight, float minimumDistance, int iterationPerPoint)
    {
    ...
    private static bool GetNextPoint(Vector2 point, Settings set, Bags bags)
    {
        ...
        if (drop == false)
        {
            ...
            bags.SamplePoints.Add(new Vector2Int(x,y));
    ...
    private static void GetFirstPoint(Settings set, Bags bags)
    {
        ...
        bags.SamplePoints.Add(new Vector2Int((int) first.x, (int) first.y));
